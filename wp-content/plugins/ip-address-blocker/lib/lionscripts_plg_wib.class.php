...
if(!class_exists('lionscripts_plg_wib'))
{
	class lionscripts_plg_wib extends lionscripts_plg
	{
		public function __construct($plg_dir)
		{
			...
			$this->plg_referer 				= '?utm_source=wib_lite_version&version='.$this->plg_version;
			$this->plg_product_url 			= LIONSCRIPTS_HOME_PAGE_URL.'product/wordpress-'.$this->plg_url_val.'-pro/'.$this->plg_referer;
		...
		public function lionscripts_plg_f()
		{
			...
			<div class="wrap">
				...
				<div class="content_left">
					<div id="lionscripts_plg_settings">
						...
						<div id="wib_blocking_option">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<label><input type="radio" name="ip_blocking_type" id="ip_blocking_type_download" onClick="jQuery('#manual_ip_block_wib_lite').hide();jQuery('#upload_ips_wib_lite').hide();jQuery('#download_ips_wib_lite').show();" /> Download Blocked IP Addresses</label>
						</div>
						...
						<div id="download_ips_wib_lite">
							<br />
							<p>
								<a href="<?php echo $this->plg_base['www'].'download_ip_addresses_csv.php?format=wib_pro'; ?>" class="button-primary">Download Complete Backup (<b>IP Blocker Pro</b> Format)</a>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="<?php echo $this->plg_base['www'].'download_ip_addresses_csv.php?format=normal'; ?>" class="button-secondary">Download in Excel/CSV (<b>IP Blocker Lite</b>) Format</a>
							</p>
						</div>
						...
						<div class="lionscripts_plg_footer">
							<p>
								<small>For all kind of Inquiries and Support, please visit at <a href="<?php echo LIONSCRIPTS_SUPPORT_PAGE_URL.'ask'.$this->plg_referer; ?>" target="_blank"><?php echo preg_replace('/\/|http\:/i', '', LIONSCRIPTS_SUPPORT_PAGE_URL); ?>/ask</a>.</small>
							</p>
							<p>
				...
				<div id="<?php echo str_replace(' ', '_', strtolower($this->plg_name)); ?>_right_container" class="content_right">
					<a href="<?php echo $this->plg_product_url; ?>&utm_medium=wibp_promo" target="_blank"><img src="<?php echo $this->plg_images['www']."pro.png"; ?>" border="0" /></a>
				</div>
			</div>
