...
- [2.10.8](http://www.codetrax.org/versions/346)
 - Adds metadata to the head section of [AMP pages](https://www.ampproject.org) generated by the [AMP](https://wordpress.org/plugins/amp/) plugin. If the Schema.org Microdata generator is enabled, it forces JSON+LD Schema.org metadata instead.
